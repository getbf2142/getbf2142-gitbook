...
OpenSpy now lets you reset your password and manage your account at [https://account.openspy.net/login](https://account.openspy.net/login). Use Partner Code <mark style="color:blue;">20 - EA</mark>.
...
If those registry entries are missing, install the missing registry files ([A04](troubleshoot.md#a04-install-the-missing-registry-files)) first, then follow the steps above.
