...
{% step %}
To fix this, go to <mark style="color:blue;">OPTIONS</mark> → <mark style="color:blue;">VIDEO</mark> and adjust the resolution first. Only choose the resolution and refresh rate that your monitor actually supports. **\[**[**?**](#user-content-fn-8)[^8]**]**
{% endstep %}
