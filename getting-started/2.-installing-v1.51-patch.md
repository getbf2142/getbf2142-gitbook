...
* It removes DRM, meaning that you no longer have to install any no-cd cracks to launch the game.
* It adds widescreen support.
* It adds Northern Strike expansion pack content to the game.
* It contains various bug fixes and additional features.
* It is the game's final version, meaning that it contains all the features that the game offers.
