...
In this tutorial, we’ll walk you through the steps to update the game to the latest version. If you have any questions or run into any issues, don’t hesitate to join our [Discord server](https://discord.com/invite/VnxTDPBebZ) — we’re always happy to help!
...
If you still need the disc to launch the game, that means you haven’t updated to v1.51 yet.
