...
9. Proceed to [patch the game to v1.51](download-and-install-v1_51-patch.md). [**DO NOT** try to omit this step](#user-content-fn-5)[^5].
...
[^4]: Since the game isn't patched to the latest version, if you try to launch the game, it will ask you to insert the game disc. Details as to why this is happening will be discussed [here](download-and-install-v1_51-patch.md).

[^5]: If you skip patching the game to the latest version, you won't be able to launch the game as it will keep asking you to insert the game disc. Details as to why this is happening will be discussed [here](download-and-install-v1_51-patch.md).
...
[^13]: If your device can run Windows 7 or above, Office 2013 or above acceptably well, then it can run this game acceptably well.
