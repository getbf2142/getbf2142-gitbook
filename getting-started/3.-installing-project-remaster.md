...
{% hint style="danger" %}
​Installation of PR is completely optional but is highly recommended. PR is a basically a must-have enhancement if you wish to enjoy the game in 2020s standard. Our tutorial will as well be heavily based on PR, so it's better to stick with us if you're new to the game or modding.
{% endhint %}
