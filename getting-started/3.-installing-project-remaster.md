...
{% hint style="warning" %}
​Installation of this mod is completely optional but is highly recommended. The tutorial will be heavily based on this mod, so it's better to stick with us if you're new to the game.
{% endhint %}
