...
If that happens, you may have to do some tweaking to your AntiVirus in order to stop it from overreacting to this .exe file. If you feel uncomfortable, cease the installation.
{% endhint %}
