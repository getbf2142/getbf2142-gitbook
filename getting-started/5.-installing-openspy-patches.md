...
To explore and switch between different master servers, it is better to use [BF2142 Unlocker](../enhancements/using-bf2142-unlocker.md). But let's stick with OpenSpy at the moment until we get a more thorough understanding of how the game works.
