...
The setup provided in this section is extracted directly from a <mark style="color:blue;">Standard Edition</mark> retail disc published by EA Taiwan back in October 2006. It contains the following international locales:
...
The setup provided in this section is prepared by Novgames for its Russian-speaking community. The installer will automatically[^6] select the Russian locale and install the latest version of the game [by default](#user-content-fn-7)[^7].
