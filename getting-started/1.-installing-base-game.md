...
2. Create a new folder on your desktop. Open <mark style="color:blue;">Setup.rar</mark>. \
   Drag and drop all the items from the .rar into the new folder.
3. Look for <mark style="color:blue;">setup.exe</mark> in the folder. \
...
5. Follow the wizard instructions to complete the installation. \
   You may refer to the special remarks below for more in-depth guidance throughout the process. \[<mark style="color:red;">Read Remarks</mark>]
