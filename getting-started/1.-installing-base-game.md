...
3. When you're asked to input the key by the wizard, simply pick any one of these cd keys to pass through the prompt. The keys are only applicable to primary downloads.\
   \
   **Standard Edition**
