...
{% hint style="warning" %}
If you're using our preferred setup (i.e., primary download), an older version of the game will be installed onto your computer. You will have to follow the instructions on the next page to fully update the game from `v1.01` up to `v1.51`.
{% endhint %}
...
{% hint style="info" %}
Most modern laptops or desktops are capable of running this game smoothly.
{% endhint %}
