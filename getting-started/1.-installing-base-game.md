...
6. Follow the wizard instructions to complete the installation. Some of the important remarks are listed [here](1.-installing-base-game.md#wizard-remarks).
7. When the installation completes, uncheck the option <mark style="color:blue;">View the README file</mark>. **DO NOT** launch the game as the game has yet not been patched to the latest version.
