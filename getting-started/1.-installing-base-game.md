...
In this tutorial, we will walk you through several download resources on the internet and the procedures to correctly install the game.
...
The setup provided in this section is a 3rd party setup prepared by Novgames for its Russian-speaking community. The installer will automatically[^7] install the Russian version of the game to your device and the game is [by default](#user-content-fn-8)[^8] patched to the latest version.
...
{% hint style="warning" %}
Most modern laptops or desktops should be able to run this game smoothly[^14].
{% endhint %}
...
[^14]: Any laptops or desktops that is able run Windows 7 or above, Office 2013 or above smoothly can run this game perfectly well.

[^15]: Graphics card is not something mandatory for this game. Intel Integrated Graphics should already be sufficient to run the game acceptably well.
