...
[^1]: The game has not been patched to the latest version. If you launch the game, it will keep asking you to insert the game disc. Details as to why this is happening will be discussed [here](../dedicated-server/2.-hosting-dedicated-server.md).

[^2]: If you skip patching the game to the latest version, you won't be able to launch the game as it will keep asking you to insert the game disc. Details as to why this is happening will be discussed [here](../dedicated-server/2.-hosting-dedicated-server.md).

[^3]: If you skip patching the game to the latest version, you won't be able to launch the game as it will keep asking you to insert the game disc. Details as to why this is happening will be discussed [here](../dedicated-server/2.-hosting-dedicated-server.md).
