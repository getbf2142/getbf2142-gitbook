...
This setup is extracted directly from a <mark style="color:blue;">Standard Edition</mark> game disc published by EA Taiwan back in 2005. It contains the following locales:
...
[^1]: If you skip patching the game to the latest version, you won't be able to launch the game as it will keep asking you to insert the game disc. Details as to why this is happening is provided on the next page.
