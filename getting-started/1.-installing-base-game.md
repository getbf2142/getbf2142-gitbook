...
3. When you are asked to provide the serial code, simply pick one of the <mark style="color:blue;">Standard Edition</mark> keys below to pass through the prompt. Note that the keys are only applicable to the setup downloaded from [Downloads](1.-installing-base-game.md#downloads) -> Primary Sources.
