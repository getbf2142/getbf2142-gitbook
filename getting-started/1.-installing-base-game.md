...
1. Download <mark style="color:blue;">Setup.rar</mark> from Downloads -> Primary Sources.
...
6. Follow the wizard instructions to complete the installation. Details are listed \[Scroll down to s<mark style="color:red;">ee Remarks</mark>]
...
Given this setup only holds an early version (i.e.,`v1.01`) of the game, you must follow the instructions on the next page right after finishing all the steps on this page to have the game patched to the latest version  (i.e.,`v1.51`).&#x20;

**If you're new to the game or you have no idea what we're doing here, we suggest always sticking to the primary sources as they're the main references we use throughout our tutorials.**
